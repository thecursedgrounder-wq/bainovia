...
public class Health : MonoBehaviour
{
    ...
    [Tooltip("Identifier reported to the quest system when this entity dies.")]
    ...
    void Die()
    {
        ...
        if (!string.IsNullOrEmpty(targetId))
        {
            ...
            if (questSystem != null)
                questSystem.OnEnemyKilled(targetId);

            BainoviaCharacterController player = Object.FindObjectOfType<BainoviaCharacterController>();
            if (player != null)
                player.AddSpiritEssence(6);
        }
